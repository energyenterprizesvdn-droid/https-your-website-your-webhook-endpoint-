...
Possible enum values:
  ...
  - `capabilities.app_distribution` (enum, nullable)
...
Possible enum values:
  ...
  - `capabilities.bizum_payments` (enum, nullable)
...
Possible enum values:
  ...
  - `capabilities.scalapay_payments` (enum, nullable)
...
Possible enum values:
  ...
  - `capabilities.sunbit_payments` (enum, nullable)
...
Possible enum values:
  ...
  - `capabilities.upi_payments` (enum, nullable)
...
- `company` (object, nullable)
  ...
  - `company.administrative_address` (object, nullable)
    The location where the business is administered.

    - `company.administrative_address.city` (string, nullable)
      City, district, suburb, town, or village.

    - `company.administrative_address.country` (string, nullable)
      Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).

    - `company.administrative_address.line1` (string, nullable)
      Address line 1, such as the street, PO Box, or company name.

    - `company.administrative_address.line2` (string, nullable)
      Address line 2, such as the apartment, suite, unit, or building.

    - `company.administrative_address.postal_code` (string, nullable)
      ZIP or postal code.

    - `company.administrative_address.state` (string, nullable)
      State, county, province, or region ([ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2)).
  ...
  - `company.principal_place_of_business` (object, nullable)
    The primary location where the business conducts operations.

    - `company.principal_place_of_business.city` (string, nullable)
      City, district, suburb, town, or village.

    - `company.principal_place_of_business.country` (string, nullable)
      Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).

    - `company.principal_place_of_business.line1` (string, nullable)
      Address line 1, such as the street, PO Box, or company name.

    - `company.principal_place_of_business.line2` (string, nullable)
      Address line 2, such as the apartment, suite, unit, or building.

    - `company.principal_place_of_business.postal_code` (string, nullable)
      ZIP or postal code.

    - `company.principal_place_of_business.state` (string, nullable)
      State, county, province, or region ([ISO 3166-2](https://en.wikipedia.org/wiki/ISO_3166-2)).
  ...
  - `company.verification` (object, nullable)
    ...
    - `company.verification.document` (object)
      ...
      - `company.verification.document.back` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      ...
      - `company.verification.document.front` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
- `external_accounts` (object)
  ...
  - `external_accounts.data` (array of objects)
    ...
    - `external_accounts.data.account` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
    ...
    - `external_accounts.data.customer` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    ...
    - `external_accounts.data.metadata` (map, nullable)
...
Possible enum values:
    ...
    - `external_accounts.data.status` (string, nullable)
      For external accounts that are cards, possible values are `new` and `errored`. If a payout fails, the status is set to `errored` and [scheduled payouts](https://docs.stripe.com/payouts.md#payout-schedule) are stopped until account details are updated.
...
Possible enum values:
      ...
      - `verification_data_not_found`
        We were unable to find information based on the data entered. Please confirm that the details are correct.
...
- `groups` (object, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
  ...
  - `individual.relationship` (object)
    ...
    - `individual.relationship.percent_ownership` (number, nullable)
...
Possible enum values:
  ...
  - `individual.verification` (object)
    ...
    - `individual.verification.additional_document` (object, nullable)
      ...
      - `individual.verification.additional_document.back` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      ...
      - `individual.verification.additional_document.front` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    ...
    - `individual.verification.document` (object)
      ...
      - `individual.verification.document.back` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
        The back of an ID returned by a [file upload](https://docs.stripe.com/api/accounts/object.md#create_file) with a `purpose` value of `identity_document`.
      ...
      - `individual.verification.document.front` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
        The front of an ID returned by a [file upload](https://docs.stripe.com/api/accounts/object.md#create_file) with a `purpose` value of `identity_document`.
...
- `settings` (object, nullable)
  ...
  - `settings.branding` (object)
    ...
    - `settings.branding.icon` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    ...
    - `settings.branding.logo` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `settings.invoices` (object, nullable)
    ...
    - `settings.invoices.default_account_tax_ids` (array of strings, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
  ...
  - `settings.smart_disputes` (object, nullable)
    Settings specific to the account’s use of Smart Disputes.

    - `settings.smart_disputes.auto_respond` (object)
      Smart Disputes auto-respond settings for the account.

      - `settings.smart_disputes.auto_respond.preference` (enum)
        The preference setting for auto-respond. Can be ‘on’, ‘off’, or ‘inherit’.

      - `settings.smart_disputes.auto_respond.value` (enum)
